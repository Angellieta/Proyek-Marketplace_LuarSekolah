...
<body>
    <div class="container">
        <aside>
            <div class="logo-nama">
                <div class="logo">
                    <img src="../img/logo.png" alt="logo-evodis" width="100px" height="100px" onclick="window.location.href='../view/index.php'"/>
                </div>
        ...
        <main class="main-user">
            <header>
                <div class="judul">Dashboard <span>> Data User</span></div>
                <a class="tambah-data" href="#">
                    <div>+ Tambah</div>
                </a>
            </header>
            <div class="brownn-user">
                <div class="whitee-user">
                    <table>
                        <tr>
                            <th class="border-rightt">No</th>
                            <th class="border-rightt">Id User</th>
                            <th class="border-rightt">Nama</th>
                            <th class="border-rightt">Email</th>
                            <th class="border-rightt">Tgl Lahir</th>
                            <th class="border-rightt">Alamat</th>
                            <th class="border-rightt">Telepon</th>
                        ...
                        <tbody>
                            ...
                            $result_count = mysqli_query($koneksi, "SELECT COUNT(*) As total_records FROM user");
                            $total_records = mysqli_fetch_array($result_count);
                            $total_records = $total_records['total_records'];
                            $total_no_of_pages = ceil($total_records / $total_records_per_page);
                            $second_last = $total_no_of_pages - 1; // total page minus 1 
                            $no = 1;
                            $result = mysqli_query($koneksi, "SELECT * FROM user LIMIT $offset, $total_records_per_page");
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                <tr>
                                    ...
                                    <td class="actionn">
                                        <div><a href="edit_user.php?id_user=<?php echo $row['id_user'] ?>"><img width="23" height="23"
                                                    src="https://img.icons8.com/puffy-filled/32/005499/experimental-create-new-puffy-filled.png"
                                                    alt="experimental-create-new-puffy-filled" /></a></div>
                                        <div><a href="proses-delete-user.php?id_user=<?php echo $row["id_user"]; ?>"><img width="23" height="23"
                                                    src="https://img.icons8.com/puffy-filled/32/000000/experimental-trash-puffy-filled.png"
                                                    alt="experimental-trash-puffy-filled" /></a></div>
                                    </td>
                                </tr>
                                <?php
                                $no++;
